...
def generate_charts(file_path, output_folder="output"):
    ...
    fig, ax = plt.subplots(figsize=(11.69, 8.27))  # Tworzenie figury i osi
    ...
    fig.text(0.05, 0.94, f"vs {session_title}", ha='left', va='bottom', fontsize=18, fontweight='bold')
    ...
    plt.suptitle(f"vs {session_title}", fontsize=18, fontweight='bold', ha='left', y=1.05)
    fig.text(0.06, 0.94, f"vs {session_title}", ha='left', va='bottom', fontsize=18, fontweight='bold')
