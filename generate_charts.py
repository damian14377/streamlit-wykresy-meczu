...
def generate_charts(file_path, output_folder="output"):
    ...
    plt.suptitle(f"vs {session_title}", fontsize=18, fontweight='bold', ha="left", y=1.05)  # Pogrubiony nagłówek
    ...
    plt.suptitle(f"vs {session_title}", fontsize=18, fontweight='bold')  # Pogrubiony nagłówek
